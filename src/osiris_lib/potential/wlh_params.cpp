...
WLH21Params<Proj::proton>::WLH21Params(json p) {
  ...
  else if (p.contains("WLHReal_V0_p")) {
    v0 = p["WLHReal_V0_p"];
    v1 = p["WLHReal_V1_p"];
    v2 = p["WLHReal_V2_p"];
    v3 = p["WLHReal_V3_p"];
...
WLH21Params<Proj::neutron>::WLH21Params(json p) {
  if (p.contains("WLHReal")) {
    ...
    a3 = p["WLHReal"]["a3_n"];
    a4 = p["WLHReal"]["a4_n"];
    w0 = p["WLHImagVolume"]["W0_n"];
    w1 = p["WLHImagVolume"]["W1_n"];
    w2 = p["WLHImagVolume"]["W2_n"];
    w3 = p["WLHImagVolume"]["W3_n"];
    w4 = p["WLHImagVolume"]["W4_n"];
    rw0 = p["WLHImagVolume"]["r0_n"];
    rw1 = p["WLHImagVolume"]["r1_n"];
    rw2 = p["WLHImagVolume"]["r2_n"];
    rw3 = p["WLHImagVolume"]["r3_n"];
    rw4 = p["WLHImagVolume"]["r4_n"];
    rw5 = p["WLHImagVolume"]["r5_n"];
    aw0 = p["WLHImagVolume"]["a0_n"];
    aw1 = p["WLHImagVolume"]["a1_n"];
    aw2 = p["WLHImagVolume"]["a2_n"];
    aw3 = p["WLHImagVolume"]["a3_n"];
    aw4 = p["WLHImagVolume"]["a4_n"];
    d0 = p["WLHImagSurface"]["W0_n"];
    d1 = p["WLHImagSurface"]["W1_n"];
    d2 = p["WLHImagSurface"]["W2_n"];
    d3 = p["WLHImagSurface"]["W3_n"];
    rs0 = p["WLHImagSurface"]["r0_n"];
    rs1 = p["WLHImagSurface"]["r1_n"];
    rs2 = p["WLHImagSurface"]["r2_n"];
    as0 = p["WLHImagSurface"]["a0_n"];
    vso_0 = p["WLHRealSpinOrbit"]["V0_n"];
    vso_1 = p["WLHRealSpinOrbit"]["V1_n"];
    rso_0 = p["WLHRealSpinOrbit"]["r0_n"];
    rso_1 = p["WLHRealSpinOrbit"]["r1_n"];
    aso_0 = p["WLHRealSpinOrbit"]["a0_n"];
    aso_1 = p["WLHRealSpinOrbit"]["a1_n"];
  }
  else if (p.contains("WLHReal_V0_n")) {
    v0 = p["WLHReal_V0_n"];
    v1 = p["WLHReal_V1_n"];
    v2 = p["WLHReal_V2_n"];
    v3 = p["WLHReal_V3_n"];
